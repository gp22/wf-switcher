 ...
 */
function wazframe_wf_switcher_block_init()
{
	register_block_type(__DIR__ . '/build');
}

add_action('init', 'wazframe_wf_switcher_block_init');
...
function add_wf_switcher_to_kses_allowed($allowed_tags)
{
	$allowed_tags['wf-switcher'] = array();
}

//add_filter('wp_kses_allowed_html', 'add_wf_switcher_to_kses_allowed');
